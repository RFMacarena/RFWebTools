...
from BallBearing.Ball_Bearing_Winston_Lutz import Read_arguments, Get_Laser, Get_centro_radiacion
...
def run_winstonlutz():
    ...
    ra = Read_arguments(argument_file, sigma, low, high)
    ...
    Genera_Informe(path_media, ra.imagenes, gl, gc)
